# Kickoff Presentation Brief — "One Machine, Three Rooms"
...
## Beat 1 — Cold open (1 min)

*Context: land the identity hook from the website, then pivot from "learning about AI" to "building with AI". The audience applied because of this promise; open by honoring it. High energy, no throat-clearing.*

- "In 18 months there'll be two kinds of B2B marketer: the ones who can build with AI, and the ones still waiting for someone to explain it."
- Today nobody explains anything. Today you build.
- One fictional company. Three challenges. And, as you'll see in a minute: one machine.

**Slide cue:** the two-kinds-of-marketer line, nothing else.

---

## Beat 2 — Meet LearnLoop (1.5 min)

*Context: introduce the fiction as a company that is WINNING. This is critical: the story is not a turnaround, nobody in it is failing. Establish the world fast with numbers; marketers trust numbers.*

- LearnLoop: B2B learning platform, Amsterdam, founded 2019.
- The pitch: most learning tools prove your people finished the training. LearnLoop proves the skill landed. "Close the loop between learning and doing."
- The numbers: €30M ARR. ~55% growth. ~750 mid-market customers. Series C in the bank.
- Customers love the product. The pitch wins deals. There's even a Berlin office with the first German logos, won the old-fashioned way: founder intros, warm network, feet on the ground.
- And the board looked at all that and wrote down a bigger number: €200M by 2030.
- (Say it with a smile:) Everything about this company is fictional. The problems you're about to see are not.

**Slide cue:** LearnLoop logo + 4 big numbers (€30M / 55% / 750 customers / €200M by 2030).

---

## Beat 3 — The wall (2 min)

*Context: the heart of the story. The villain is arithmetic, not people. Slow down here; this is the part every person in the room has lived. Land the three examples as three flavors of the same problem.*

- Growth is fine. The COST of growth is the problem: every euro of new pipeline still scales with headcount.
- Three snapshots from inside LearnLoop:
  - ONE RevOps analyst reads four data sources. Nobody agrees what the numbers mean, so every meeting re-litigates them.
  - SIX writers publish under the brand. The voice is held together by hand-editing, one draft at a time. Next quarter it also has to work in German and Spanish.
  - Personalised outreach is artisanal. So when the warm network in Germany ran dry, the 3-person Berlin pod fell back on templates: 3,200 emails. 13 replies. 0.4%.
- To grow 6x from here, the old answer is: hire 6x the people. Everyone who has tried that knows what it does to cost, ramp time, and quality.
- Heads don't multiply. Systems do.

**Slide cue:** three numbers stacked: 1 analyst / 6 writers / 0.4% reply.

---

## Beat 4 — The thesis (1 min)

*Context: name the discipline. This is the "what this day is actually about" moment and the line marketers take home. Keep it tight and confident.*

- Watch any great marketer or SDR work. Three skills, running from their head:
  - They SENSE: who is worth it, what changed, why now.
  - They SPEAK: what to say, to which persona, in whose voice.
  - They REACH: land it, thread the account, earn the reply.
- LearnLoop's problem is not strategy. They know their market, their ICP, their pitch. The problem is that all three skills live in people's heads: artisanal, undocumented, linear.
...
## Beat 5 — The mission: three briefs, three subsystems (1.5 min)
